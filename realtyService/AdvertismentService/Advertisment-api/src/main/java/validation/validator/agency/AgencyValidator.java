...
public class AgencyValidator implements ConstraintValidator<AgencyConstraint, AgencyRequest> {
    ...
    @Override
    public boolean isValid(AgencyRequest value, ConstraintValidatorContext context) {
