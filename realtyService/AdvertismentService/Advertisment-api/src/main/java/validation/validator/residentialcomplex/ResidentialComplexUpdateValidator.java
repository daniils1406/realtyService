...
public class ResidentialComplexUpdateValidator implements ConstraintValidator<ResidentialComplexConstraint, ResidentialComplexUpdateRequest> {
    ...
    @Override
    public boolean isValid(ResidentialComplexUpdateRequest value, ConstraintValidatorContext context) {
